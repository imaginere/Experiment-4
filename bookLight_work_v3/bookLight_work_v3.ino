...
#include <UniversalTelegramBot.h> // Used for Telegram
#include <IFTTTMaker.h> // used or IFTT

// Code for he IFTT

// ------- IFTTT Maker config --------
#define KEY "bB4Gj_HbDwGZb_kj3IrAu3"  // Get it from this page https://ifttt.com/services/maker/settings
#define EVENT_NAME "emailLamp" // Name of your event name, set when you are creating the applet
...
///////// the code above is for the email
